...
Tile.TileType.WallTile

print(f'Ball Tiles: {arcadeScreen.countTiles(Tile.TileType.BallTile)}')
print(f'Block Tiles: {arcadeScreen.countTiles(Tile.TileType.BlockTile)}')
